...
train_input_dir = config.train_input_dir # Load from config
train_mask_dir = config.train_mask_dir    # Load from config
...
# Data Transformation
img_transform = transforms.Compose([  # Changed img_tf to img_transform for consistency
    transforms.ToTensor()
])
if config.mask_augment:
    mask_transform = transforms.Compose([  # Changed mask_tf to mask_transform for consistency
...
# dataset_train = CustomInpaintingDataset(input_dir=your_train_input_dir, mask_dir=your_train_mask_dir, ...)
